...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // identify follow and unfollow buttons
    let follow = document.querySelector("#follow-button");
    let unfollow = document.querySelector("#unfollow-button");
    ...
    if (follow) {
        follow.addEventListener("click", () => {
            // fetch request to create follow instance
            fetch(`/follow`, {
                method: "POST",
                headers: {
            ...
            .then(response => {
                document.querySelector("#follower-count").innerHTML = `Followers: ${response.followers}`;
    
                // hide follow button and show unfollow button
                follow.setAttribute("style", "display: none;")
                unfollow.setAttribute("style", "display: block;")
            })
        })
    }
    ...
    if (unfollow) {
        unfollow.addEventListener("click", () => {
            ...
            .then(response => {
                ...
                // hide follow button and show unfollow button
                follow.setAttribute("style", "display: block;")
                unfollow.setAttribute("style", "display: none;")
            })
        })
    }
